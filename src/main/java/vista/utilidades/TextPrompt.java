...
/**
 * RESUMEN= PLACEHOLDER ejemplo uso=
 * https://es.stackoverflow.com/questions/42187/c%C3%B3mo-agregar-un-placeholder-en-un-jtextfield
...
public class TextPrompt extends JLabel implements FocusListener, DocumentListener {
   ...
   * shown again.
   *
   * @param showPromptOnce when true the prompt will only be shown once, otherwise it will be shown
   *        repeatedly.
   */
